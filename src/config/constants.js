...
export const PLAYER_HURT_ANIMATION_DURATION = 0.6
export const PLAYER_INVULNERABLE_DURATION = 2
export const PLAYER_ESCAPE_DURATION = 2
export const PLAYER_BOMB_ANIMATION_DURATION = 0.7
export const PLAYER_BOMB_APPEAR_DELAY = 0.5
